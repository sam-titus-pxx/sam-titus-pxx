...
$(document).ready(function(){
   ...
   loadList(services,"services-list")
   
  /* loadProducts(0,"slider1")
   loadProducts(1,"slider2")
   loadProducts(2,"slider3")
   loadProducts(3,"slider4")
   loadProducts(4,"slider5")*/
   ...
   console.log("MAC-BLUE ZEAL GLOBAL RESOURCES LTD.!")
